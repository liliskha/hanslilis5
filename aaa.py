...
kd = LINETCR.LINE()
kd.login(token='YOUR_TOKEN')

ke = LINETCR.LINE()
ke.login(token='YOUR_TOKEN')

kf = LINETCR.LINE()
kf.login(token='YOUR_TOKEN')

kg = LINETCR.LINE()
kg.login(token='YOUR_TOKEN')

kh = LINETCR.LINE()
kh.login(token='YOUR_TOKEN')

kj = LINETCR.LINE()
kj.login(token='YOUR_TOKEN')

kl = LINETCR.LINE()
kl.login(token='YOUR_TOKEN')

print "login succes"
reload(sys)
sys.setdefaultencoding('utf-8')

helpMessage ="""[🔥] PSD BOT HELP COMMAND [🔥]
[☸] COMMAND USER [☸]
...
#===========================================
        ...
        if op.type == 25:
               ...
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"tidak ada pendingan nah")
                        else:
			...
			kd.sendText(msg.to,Amid)
			ke.sendText(msg.to,Bmid)
			kf.sendText(msg.to,cmid)
			kg.sendText(msg.to,Amid)
			kh.sendText(msg.to,Bmid)
			kj.sendText(msg.to,cmid)
...
#======================================
            ...
            elif "R9 rename: " in msg.text:
                string = msg.text.replace("R9 rename: ","")
                if len(string.decode('utf-8')) <= 20:
